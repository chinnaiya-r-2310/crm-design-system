import{i as e,s as t}from"./preload-helper-BTXe9M7S.js";import{N as n}from"./iframe-CUMN0NDL.js";import{t as r}from"./jsx-runtime-D-I7Lrue.js";import{E as i,et as a}from"./Icons-D2Putz0a.js";import{n as o,t as s}from"./Checkbox-BauWl4tL.js";import{n as c,t as l}from"./Tooltip-hLvqG6AG.js";import{n as u,t as d}from"./MessageBox-CvFPVowM.js";import{n as f,t as p}from"./MessageInfo-BQUrdfOl.js";import{n as m,t as h}from"./Modal-CCs536s2.js";import{n as g,t as _}from"./Tags-DMi4bJ0I.js";function v(e,t){let n=new Date(e);return n.setFullYear(n.getFullYear()-t),n}function y(e,t){let n=new Date(e);return n.setDate(n.getDate()-t),n}function b(e){return`${E[e.getMonth()]} ${e.getDate()}, ${e.getFullYear()}`}function x({min:e=0,max:t=10,maxA:n=t,valueA:r,valueB:i,onChangeA:a,onChangeB:o,showThumbB:s=!0}){let c=(0,C.useRef)(null),l=Array.from({length:t-e+1},(t,n)=>n+e),u=l.length,d=(r-e)/(t-e)*100,f=(i-e)/(t-e)*100,p=(0,C.useCallback)(n=>{let r=c.current.getBoundingClientRect(),i=Math.min(1,Math.max(0,(n-r.left)/r.width));return Math.round(e+i*(t-e))},[e,t]),m=e=>t=>{t.preventDefault();let s=t=>{let s=p(t.clientX);e===`a`?a(Math.min(Math.max(s,1),Math.min(i,n))):o(Math.max(s,r,2))},c=()=>{document.removeEventListener(`mousemove`,s),document.removeEventListener(`mouseup`,c)};document.addEventListener(`mousemove`,s),document.addEventListener(`mouseup`,c)},h={position:`absolute`,width:19,height:19,top:`50%`,transform:`translate(-50%, -50%)`,borderRadius:`50%`,background:`#fff`,border:`2px solid #9C9CA6`,boxShadow:`0 3px 12px rgba(49,57,73,0.15)`,boxSizing:`border-box`,cursor:`grab`,outline:`none`,transition:`left 80ms ease, border-color 120ms, box-shadow 120ms`,zIndex:1};return(0,w.jsxs)(`div`,{style:{userSelect:`none`,width:`100%`,fontFamily:`var(--ds-font-family-base)`},children:[(0,w.jsx)(`style`,{children:`
        .ds-thumb-dot:hover {
  ...
  render: () => {
    ...
    return <>
        <Modal isOpen={open} title="Manage Log Retention Settings" description="Choose how long the logs should stay visible and archived in the Audit Log." onClose={() => setOpen(false)} onCancel={() => setOpen(false)} onSave={() => {
        setSaving(true);
        setTimeout(() => {
          setSaving(false);
          setOpen(false);
      ...
      }} saveLoading={saving} cancelLabel="Cancel" saveLabel="Save" width={640}>
          <div style={{
          display: 'flex',
          ...
          paddingRight: 20
            ...
            gap: 20
              ...
              <RetentionRow dotColor="var(--ds-components-slider-active-bg-fill-color, #5464F2)" showDot={archiveEnabled} label="Visible Log History" years={visibleYears} availableFrom={fmtDate(visibleStart)} availableTo="Now" />
            ...
            gap: 12
              ...
              gap: 8
                ...
                <Checkbox label="Modules Exempt from Standard Duration" checked={exemptEnabled} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setExemptEnabled(e.target.checked)} />
