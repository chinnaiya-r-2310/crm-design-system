import{i as e}from"./preload-helper-CJc2i8B4.js";import{t}from"./jsx-runtime-BsPI7X8G.js";import{$ as n,A as r,B as i,C as a,D as o,E as s,F as c,G as l,H as ee,I as te,J as u,K as ne,L as re,M as ie,N as ae,O as oe,P as se,Q as ce,R as le,S as ue,T as d,U as f,V as de,W as fe,X as pe,Y as p,Z as m,_ as h,a as g,b as _,c as me,d as v,et as y,f as b,g as he,h as x,i as S,j as ge,k as _e,l as ve,m as C,n as w,o as ye,p as be,q as T,r as E,s as xe,t as Se,u as D,v as O,w as k,x as A,y as j,z as Ce}from"./Icons-BFiFKMZX.js";var M,N=e((()=>{y(),M={AlertError:w,AlertInfo:E,AlertSuccess:S,AlertWarning:g,Check:v,ChevronDownFilled:b,Close:C,CloseSmall:x,CompanyAvatar:h,CriteriaMinus:O,CriteriaPlus:j,Edit:_,GroupAvatar:a,HelpCircle:k,ImageAvatar:d,Info:s,Lock:o,More:l,ResizeHandle:T,Search:u,UserAvatar:m}}));function P({name:e,size:t=16,className:n,title:r,"aria-label":i,"aria-hidden":a}){let o=M[e],s=i??r,c=!!s;return(0,F.jsx)(o,{width:t,height:t,className:n,"aria-label":s,"aria-hidden":a??(!c||void 0),role:c?`img`:void 0})}var F,we=e((()=>{F=t(),N(),P.__docgenInfo={description:`Renders a design-system icon from the central registry.
