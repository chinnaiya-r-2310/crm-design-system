import{i as e,s as t}from"./preload-helper-BdFrVu1K.js";import{N as n}from"./iframe-CqNH1q5E.js";import{t as r}from"./jsx-runtime-f3rHp9ZU.js";import{d as i,f as a,g as o}from"./Icons-CL4OXD18.js";var s,c,l,u,d,f,p,m,h,g,_,v,y=e((()=>{s=`_root_xkmz3_7`,c=`_vertical_xkmz3_17`,l=`_formRow_xkmz3_8`,u=`_fieldColumn_xkmz3_10`,d=`_label_xkmz3_9`,f=`_inputWrapper_xkmz3_11`,p=`_suffixSlot_xkmz3_192`,m=`_input_xkmz3_11`,h=`_helperText_xkmz3_13`,g=`_datetimeParts_xkmz3_326`,_=`_datetimeDivider_xkmz3_338`,v={root:s,vertical:c,formRow:l,fieldColumn:u,label:d,inputWrapper:f,suffixSlot:p,input:m,helperText:h,datetimeParts:g,datetimeDivider:_}}));function b({label:e,helperText:t,width:n=670,type:r=`text`,layout:o=`horizontal`,suffix:s,columns:c,error:l,autoUpdate:u,forceState:d,id:f,style:p,className:m,readOnly:h,timeValue:g,onTimeChange:_,...y}){let b=(0,x.useId)(),C=f??b,w=r===`lookup`,T=r===`date`,E=r===`datetime`,D={width:typeof n==`number`?`${n}px`:n,...p},O=y.disabled?`disabled`:h?`readonly`:l?`error`:u?`auto-update`:void 0,k=d===void 0?{}:{"data-state":d},A=w||T||E?`text`:r,j=(0,S.jsx)(a,{"aria-hidden":`true`}),M=h||w&&y.disabled?j:w?(0,S.jsx)(i,{"aria-hidden":`true`}):s,N=w&&!y.placeholder?`Select`:(T||E)&&!y.placeholder?`DD/MM/YYYY`:y.placeholder,P=E?(0,S.jsxs)(`div`,{className:v.datetimeParts,"aria-label":`Date and time`,children:[(0,S.jsx)(`input`,{id:C,type:`text`,className:v.input,placeholder:`DD/MM/YYYY`,"aria-label":`Date`,"aria-describedby":t?`${C}-helper`:void 0,value:y.value,onChange:y.onChange,readOnly:h,disabled:y.disabled,required:y.required}),(0,S.jsx)(`span`,{className:v.datetimeDivider,"aria-hidden":`true`}),(0,S.jsx)(`input`,{type:`text`,className:v.input,placeholder:`HH:MM`,"aria-label":`Time`,value:g,onChange:_,readOnly:h,disabled:y.disabled})]}):(0,S.jsx)(`input`,{id:C,type:A,className:v.input,"aria-describedby":t?`${C}-helper`:void 0,readOnly:w||h,...y,placeholder:N,onWheel:A===`number`?e=>e.currentTarget.blur():y.onWheel}),F=t?(0,S.jsx)(`span`,{id:`${C}-helper`,className:v.helperText,children:t}):null,I=e?(0,S.jsx)(`label`,{className:v.label,htmlFor:C,onClick:e=>e.preventDefault(),children:e}):null,L=(0,S.jsxs)(`div`,{className:v.inputWrapper,"data-required":y.required||void 0,"data-has-suffix":M?!0:void 0,"data-type":w?`lookup`:void 0,...k,children:[P,M&&(0,S.jsx)(`span`,{className:v.suffixSlot,"aria-hidden":`true`,children:M})]});if(o===`horizontal`&&e){let e=c?{gridTemplateColumns:c}:void 0;return(0,S.jsx)(`div`,{className:v.root,style:D,"data-variant":O,"data-type":w?`lookup`:void 0,children:(0,S.jsxs)(`div`,{className:v.formRow,style:e,children:[I,(0,S.jsxs)(`div`,{className:v.fieldColumn,children:[L,F]})]})})}return(0,S.jsxs)(`div`,{className:`${v.root} ${v.vertical}`,style:D,"data-variant":O,"data-type":w?`lookup`:void 0,children:[I,L,F]})}var x,S,C=e((()=>{x=t(n(),1),y(),o(),S=r(),b.__docgenInfo={description:`Base Input component.
