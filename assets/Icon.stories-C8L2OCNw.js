import{i as e}from"./preload-helper-BTXe9M7S.js";import{t}from"./jsx-runtime-D-I7Lrue.js";import{$ as n,A as r,B as i,D as a,E as o,F as s,G as c,H as ee,I as te,J as ne,K as re,L as ie,M as l,N as u,O as ae,P as d,Q as oe,R as se,U as ce,V as le,W as ue,X as de,Y as fe,Z as pe,_ as f,a as p,at as m,b as h,c as me,ct as he,d as g,dt as ge,et as _e,f as _,ft as ve,g as ye,h as v,i as y,it as be,j as b,k as x,l as xe,lt as Se,m as S,n as C,nt as w,o as Ce,ot as T,p as we,pt as E,q as Te,r as D,rt as O,s as Ee,st as De,t as Oe,tt as k,u as ke,ut as Ae,v as A,y as j,z as je}from"./Icons-HJwscVC1.js";var M,N=e((()=>{E(),M={AlertError:C,AlertInfo:D,AlertSuccess:y,AlertWarning:p,Check:g,ChevronDownFilled:_,Close:S,CloseSmall:v,CompanyAvatar:f,CriteriaMinus:j,CriteriaPlus:h,Edit:o,GroupAvatar:x,HelpCircle:b,ImageAvatar:l,Info:d,Lock:s,More:n,ResizeHandle:k,Search:w,UserAvatar:m}}));function P({name:e,size:t=16,className:n,title:r,"aria-label":i,"aria-hidden":a}){let o=M[e],s=i??r,c=!!s;return(0,F.jsx)(o,{width:t,height:t,className:n,"aria-label":s,"aria-hidden":a??(!c||void 0),role:c?`img`:void 0})}var F,Me=e((()=>{F=t(),N(),P.__docgenInfo={description:`Renders a design-system icon from the central registry.
...
────────────
  ...
  3. The IconName union updates automatically.`,methods:[],displayName:`Icon`,props:{size:{defaultValue:{value:`16`,computed:!1},required:!1}}}}));function I({label:e,children:t}){return(0,L.jsxs)(`div`,{style:J,title:e,children:[t,(0,L.jsx)(`span`,{style:Y,children:e})]})}var L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{Me(),N(),E(),L=t(),R=Object.keys(M).sort(),z={title:`Design System/Foundations/Icons`,component:P,parameters:{layout:`centered`,docs:{description:{component:["Renders a design-system icon from the central registry (`iconMap.ts`).",`Source: crm-icon-library Figma file (node 91-19).`,`Icons: AlertError · AlertInfo · AlertSuccess · AlertWarning · Check · ChevronDownFilled · Close · CloseSmall · CompanyAvatar · CriteriaMinus · CriteriaPlus · Edit · GroupAvatar · HelpCircle · ImageAvatar · Info · Lock · More · ResizeHandle · Search · UserAvatar.`,"Line icons use `currentColor`. Alert icons use fixed Figma brand colors."].join(` `)}}},argTypes:{name:{control:`select`,options:R,description:"Icon to render — must match a key in `iconMap`",table:{category:`Core`}},size:{control:{type:`number`,min:12,max:64,step:4},description:`Width and height in px — icon scales proportionally`,table:{category:`Core`,defaultValue:{summary:`16`}}},className:{control:`text`,description:`CSS class applied to the SVG element (use for color via currentColor)`,table:{category:`Styling`}},title:{control:`text`,description:`Accessible label — applied as aria-label; turns the icon into role="img"`,table:{category:`Accessibility`}},"aria-label":{control:`text`,description:`Explicit aria-label — overrides title`,table:{category:`Accessibility`}},"aria-hidden":{control:`boolean`,description:`Override auto aria-hidden (true by default for decorative icons)`,table:{category:`Accessibility`}}}},B={name:`Playground`,args:{name:`Info`,size:24},render:e=>(0,L.jsx)(`div`,{style:{color:`var(--ds-text-base)`},children:(0,L.jsx)(P,{...e})})},V={name:`Gallery`,parameters:{controls:{disable:!0}},render:()=>(0,L.jsxs)(`div`,{style:{fontFamily:`var(--ds-font-family-base)`},children:[(0,L.jsxs)(`div`,{style:{fontSize:`11px`,color:`var(--ds-text-label)`,marginBottom:`16px`,letterSpacing:`0.02em`},children:[R.length,` icons`]}),(0,L.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fill, minmax(88px, 1fr))`,gap:`8px`,width:`800px`,maxWidth:`100%`},children:R.map(e=>(0,L.jsxs)(`div`,{title:e,style:{display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:`10px`,padding:`20px 8px 14px`,border:`1px solid var(--ds-components-input-default-outline)`,borderRadius:`8px`,background:`var(--ds-bg-common-card)`,color:`var(--ds-text-base)`,cursor:`default`,transition:`background 120ms`},children:[(0,L.jsx)(P,{name:e,size:20}),(0,L.jsx)(`span`,{style:{fontSize:`11px`,color:`var(--ds-text-label)`,textAlign:`center`,lineHeight:`14px`,wordBreak:`break-word`},children:e})]},e))})]})},H={name:`Size Scale`,parameters:{controls:{disable:!0}},render:()=>(0,L.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`24px`,color:`var(--ds-text-base)`,fontFamily:`var(--ds-font-family-base)`},children:[12,16,20,24,32,48].map(e=>(0,L.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`8px`},children:[(0,L.jsx)(P,{name:`Info`,size:e}),(0,L.jsxs)(`span`,{style:{fontSize:`11px`,color:`var(--ds-text-label)`},children:[e,`px`]})]},e))})},U={name:`Color Inheritance`,parameters:{controls:{disable:!0}},render:()=>(0,L.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`20px`,fontFamily:`var(--ds-font-family-base)`},children:[[`var(--ds-text-base)`,`Base`],[`var(--ds-text-label)`,`Label`],[`#5464F2`,`Primary`],[`#FF5D5A`,`Error`],[`#F5A623`,`Warning`],[`#2ECC71`,`Success`]].map(([e,t])=>(0,L.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`8px`,color:e},children:[(0,L.jsx)(P,{name:`Lock`,size:20}),(0,L.jsx)(`span`,{style:{fontSize:`11px`},children:t})]},t))})},W={name:`Alert Icons`,parameters:{controls:{disable:!0}},render:()=>(0,L.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`24px`,fontFamily:`var(--ds-font-family-base)`},children:[[y,`AlertSuccess`,`#12AA67`],[C,`AlertError`,`#FF5D5A`],[p,`AlertWarning`,`#F18E0A`],[D,`AlertInfo`,`#24CBB7`]].map(([e,t,n])=>(0,L.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`8px`},children:[(0,L.jsx)(e,{}),(0,L.jsx)(`span`,{style:{fontSize:`11px`,color:`var(--ds-text-label)`,textAlign:`center`},children:t}),(0,L.jsx)(`span`,{style:{fontSize:`10px`,color:n,fontWeight:600},children:n})]},t))})},G={name:`Line Icons`,parameters:{controls:{disable:!0}},render:()=>(0,L.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`24px`,fontFamily:`var(--ds-font-family-base)`,color:`var(--ds-text-base)`},children:[[g,`Check`,11],[_,`ChevronDownFilled`,10],[S,`Close`,8],[v,`CloseSmall`,8],[j,`CriteriaMinus`,16],[h,`CriteriaPlus`,16],[o,`Edit`,12],[b,`HelpCircle`,16],[d,`Info`,18],[s,`Lock`,16],[n,`More`,16],[k,`ResizeHandle`,10],[w,`Search`,14]].map(([e,t,n])=>(0,L.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`8px`},children:[(0,L.jsx)(e,{width:n,height:n}),(0,L.jsx)(`span`,{style:{fontSize:`11px`,color:`var(--ds-text-label)`,textAlign:`center`},children:t})]},t))})},K={name:`Avatar Icons`,parameters:{controls:{disable:!0}},render:()=>(0,L.jsxs)(`div`,{style:{fontFamily:`var(--ds-font-family-base)`,display:`flex`,flexDirection:`column`,gap:`20px`},children:[(0,L.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`24px`},children:[[m,`UserAvatar`],[x,`GroupAvatar`],[f,`CompanyAvatar`],[l,`ImageAvatar`]].map(([e,t])=>(0,L.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`8px`},children:[(0,L.jsx)(e,{width:48,height:48}),(0,L.jsx)(`span`,{style:{fontSize:`11px`,color:`var(--ds-text-label)`,textAlign:`center`},children:t})]},t))}),(0,L.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`24px`},children:[[T,`UserAvatarDark`],[r,`GroupAvatarDark`],[A,`CompanyAvatarDark`],[u,`ImageAvatarDark`]].map(([e,t])=>(0,L.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`8px`},children:[(0,L.jsx)(e,{width:48,height:48}),(0,L.jsx)(`span`,{style:{fontSize:`11px`,color:`var(--ds-text-label)`,textAlign:`center`},children:t})]},t))})]})},q={name:`Accessibility`,parameters:{controls:{disable:!0}},render:()=>(0,L.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`16px`,fontFamily:`var(--ds-font-family-base)`,fontSize:`14px`,color:`var(--ds-text-base)`},children:[(0,L.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,L.jsx)(P,{name:`Info`,size:16}),(0,L.jsx)(`span`,{children:`Decorative — aria-hidden="true" applied automatically (no label needed)`})]}),(0,L.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,L.jsx)(P,{name:`Lock`,size:16,"aria-label":`Locked`}),(0,L.jsx)(`span`,{children:`Meaningful — role="img" aria-label="Locked" (screen readers announce it)`})]}),(0,L.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`},children:[(0,L.jsx)(P,{name:`Search`,size:16,title:`Search records`}),(0,L.jsx)(`span`,{children:`Meaningful via title — same effect as aria-label`})]})]})},J={display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,gap:`10px`,padding:`18px 8px 12px`,border:`1px solid var(--ds-components-input-default-outline)`,borderRadius:`8px`,background:`var(--ds-bg-common-card)`,cursor:`default`},Y={fontSize:`10px`,color:`var(--ds-text-label)`,textAlign:`center`,lineHeight:`13px`,wordBreak:`break-word`,maxWidth:`80px`},X={display:`grid`,gridTemplateColumns:`repeat(auto-fill, minmax(96px, 1fr))`,gap:`8px`},Z={fontSize:`11px`,fontWeight:600,color:`var(--ds-text-label)`,letterSpacing:`0.06em`,textTransform:`uppercase`,marginBottom:`10px`,marginTop:`28px`},Q={name:`All Icons`,parameters:{controls:{disable:!0},layout:`padded`},render:()=>(0,L.jsxs)(`div`,{style:{fontFamily:`var(--ds-font-family-base)`,maxWidth:`960px`,color:`var(--ds-text-base)`},children:[(0,L.jsx)(`div`,{style:Z,children:`Utility`}),(0,L.jsx)(`div`,{style:X,children:[[`Info`,(0,L.jsx)(d,{width:18,height:18},`i`)],[`Lock`,(0,L.jsx)(s,{width:16,height:16},`l`)],[`Search`,(0,L.jsx)(w,{width:14,height:14},`s`)],[`More`,(0,L.jsx)(n,{width:16,height:16},`m`)],[`Check`,(0,L.jsx)(g,{width:11,height:8},`ch`)],[`ChevronDownFilled`,(0,L.jsx)(_,{width:10,height:5},`cdf`)],[`ChevronUp`,(0,L.jsx)(we,{width:10,height:5},`cu`)],[`Edit`,(0,L.jsx)(o,{width:12,height:12},`e`)],[`Close`,(0,L.jsx)(S,{width:8,height:8},`cl`)],[`CloseSmall`,(0,L.jsx)(v,{width:8,height:8},`cs`)],[`ResizeHandle`,(0,L.jsx)(k,{width:10,height:10},`r`)],[`CriteriaMinus`,(0,L.jsx)(j,{width:16,height:16},`cm`)],[`CriteriaPlus`,(0,L.jsx)(h,{width:16,height:16},`cp`)],[`HelpCircle`,(0,L.jsx)(b,{width:16,height:16},`hc`)],[`Folder`,(0,L.jsx)(ae,{width:16,height:14},`fo`)],[`SidebarCollapse`,(0,L.jsx)(be,{width:16,height:16},`sc`)]].map(([e,t])=>(0,L.jsx)(I,{label:e,children:t},e))}),(0,L.jsx)(`div`,{style:Z,children:`Alert`}),(0,L.jsx)(`div`,{style:X,children:[[`AlertSuccess`,(0,L.jsx)(y,{width:22,height:22},`as`)],[`AlertError`,(0,L.jsx)(C,{width:22,height:22},`ae`)],[`AlertWarning`,(0,L.jsx)(p,{width:22,height:22},`aw`)],[`AlertInfo`,(0,L.jsx)(D,{width:22,height:22},`ai`)]].map(([e,t])=>(0,L.jsx)(I,{label:e,children:t},e))}),(0,L.jsx)(`div`,{style:Z,children:`Avatar`}),(0,L.jsx)(`div`,{style:X,children:[[`UserAvatar`,(0,L.jsx)(m,{width:40,height:40},`ua`)],[`GroupAvatar`,(0,L.jsx)(x,{width:40,height:40},`ga`)],[`CompanyAvatar`,(0,L.jsx)(f,{width:40,height:40},`ca`)],[`ImageAvatar`,(0,L.jsx)(l,{width:40,height:40},`ima`)],[`UserAvatarDark`,(0,L.jsx)(T,{width:40,height:40},`uad`)],[`GroupAvatarDark`,(0,L.jsx)(r,{width:40,height:40},`gad`)],[`CompanyAvatarDark`,(0,L.jsx)(A,{width:40,height:40},`cad`)],[`ImageAvatarDark`,(0,L.jsx)(u,{width:40,height:40},`iad`)]].map(([e,t])=>(0,L.jsx)(I,{label:e,children:t},e))}),(0,L.jsx)(`div`,{style:Z,children:`Module`}),(0,L.jsx)(`div`,{style:X,children:[[`Home`,(0,L.jsx)(c,{width:16,height:15},`mh`)],[`Analytics`,(0,L.jsx)(se,{width:17,height:16},`man`)],[`Reports`,(0,L.jsx)(de,{width:16,height:16},`mr`)],[`Leads`,(0,L.jsx)(re,{width:16,height:16},`ml`)],[`Contacts`,(0,L.jsx)(i,{width:16,height:16},`mc`)],[`Accounts`,(0,L.jsx)(te,{width:17,height:16},`mac`)],[`Deals`,(0,L.jsx)(ee,{width:16,height:16},`md`)],[`Forecasts`,(0,L.jsx)(ue,{width:16,height:16},`mf`)],[`Products`,(0,L.jsx)(fe,{width:16,height:16},`mp`)],[`Cases`,(0,L.jsx)(je,{width:18,height:16},`mca`)],[`Solutions`,(0,L.jsx)(oe,{width:17,height:16},`ms`)],[`Activities`,(0,L.jsx)(ie,{width:16,height:16},`ma`)],[`Meeting`,(0,L.jsx)(Te,{width:16,height:18},`mm`)],[`Docs`,(0,L.jsx)(ce,{width:16,height:16},`mdo`)],[`Social`,(0,L.jsx)(pe,{width:16,height:16},`mso`)],[`Custom`,(0,L.jsx)(le,{width:16,height:16},`mcu`)],[`My Jobs`,(0,L.jsx)(ne,{width:16,height:16},`mmj`)]].map(([e,t])=>(0,L.jsx)(I,{label:e,children:t},e))}),(0,L.jsx)(`div`,{style:Z,children:`Top Bar`}),(0,L.jsx)(`div`,{style:X,children:[[`Bell`,(0,L.jsx)(me,{width:18,height:18},`bl`)],[`Calendar`,(0,L.jsx)(ke,{width:18,height:18},`cl`)],[`Settings`,(0,L.jsx)(O,{width:18,height:18},`sg`)],[`BentoMenu`,(0,L.jsx)(xe,{width:16,height:16},`bm`)],[`ZiaAI`,(0,L.jsx)(ve,{width:21,height:20},`za`)],[`AppMarket`,(0,L.jsx)(Ee,{width:18,height:17},`am`)]].map(([e,t])=>(0,L.jsx)(I,{label:e,children:t},e))}),(0,L.jsx)(`div`,{style:Z,children:`WMS Bar`}),(0,L.jsx)(`div`,{style:X,children:[[`Motivator`,(0,L.jsx)(_e,{width:14,height:14},`mo`)],[`AlarmClock`,(0,L.jsx)(Oe,{width:16,height:15},`ac`)],[`Zia`,(0,L.jsx)(ge,{width:17,height:13},`zi`)],[`File`,(0,L.jsx)(a,{width:13,height:15},`fi`)],[`Comment`,(0,L.jsx)(ye,{width:14,height:14},`co`)],[`Announcement`,(0,L.jsx)(Ce,{width:13,height:17},`an`)],[`WmsChat`,(0,L.jsx)(he,{width:14,height:14},`wc`)],[`WmsChannel`,(0,L.jsx)(De,{width:14,height:14},`wch`)],[`WmsNotes`,(0,L.jsx)(Se,{width:13,height:15},`wn`)],[`WmsUsers`,(0,L.jsx)(Ae,{width:14,height:14},`wu`)]].map(([e,t])=>(0,L.jsx)(I,{label:e,children:t},e))})]})},B.parameters={...B.parameters,docs:{...B.parameters?.docs,source:{originalSource:`{
  name: 'Playground',
  args: {
    name: 'Info',
    size: 24
...
Automatically reflects iconMap — add a new entry there and it appears here.`,...V.parameters?.docs?.description}}},H.parameters={...H.parameters,docs:{...H.parameters?.docs,source:{originalSource:`{
  ...
  render: () => <div style={{
    ...
    gap: '20px'
      ...
      gap: '24px'
        ...
        {([[UserAvatarDark, 'UserAvatarDark'], [GroupAvatarDark, 'GroupAvatarDark'], [CompanyAvatarDark, 'CompanyAvatarDark'], [ImageAvatarDark, 'ImageAvatarDark']] as const).map(([Comp, label]) => <div key={label} style={{
        display: 'flex',
        flexDirection: 'column',
        alignItems: 'center',
        gap: '8px'
  ...
  render: () => <div style={{
    ...
    color: 'var(--ds-text-base)'
      ...
      <div style={GRID_STYLE}>
        {([['UserAvatar', <UserAvatar key="ua" width={40} height={40} />], ['GroupAvatar', <GroupAvatar key="ga" width={40} height={40} />], ['CompanyAvatar', <CompanyAvatar key="ca" width={40} height={40} />], ['ImageAvatar', <ImageAvatar key="ima" width={40} height={40} />], ['UserAvatarDark', <UserAvatarDark key="uad" width={40} height={40} />], ['GroupAvatarDark', <GroupAvatarDark key="gad" width={40} height={40} />], ['CompanyAvatarDark', <CompanyAvatarDark key="cad" width={40} height={40} />], ['ImageAvatarDark', <ImageAvatarDark key="iad" width={40} height={40} />]] as [string, React.ReactNode][]).map(([label, el]) => <IconCell key={label} label={label}>{el}</IconCell>)}
      </div>
      ...
      <div style={GRID_STYLE}>
        {([['Motivator', <Motivator key="mo" width={14} height={14} />], ['AlarmClock', <AlarmClock key="ac" width={16} height={15} />], ['Zia', <Zia key="zi" width={17} height={13} />], ['File', <File key="fi" width={13} height={15} />], ['Comment', <Comment key="co" width={14} height={14} />], ['Announcement', <Announcement key="an" width={13} height={17} />], ['WmsChat', <WmsChat key="wc" width={14} height={14} />], ['WmsChannel', <WmsChannel key="wch" width={14} height={14} />], ['WmsNotes', <WmsNotes key="wn" width={13} height={15} />], ['WmsUsers', <WmsUsers key="wu" width={14} height={14} />]] as [string, React.ReactNode][]).map(([label, el]) => <IconCell key={label} label={label}>{el}</IconCell>)}
      </div>
