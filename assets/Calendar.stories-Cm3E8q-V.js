  ...
  render: () => {
    ...
    return <div style={{
      ...
      alignItems: 'center'
        ...
        <Calendar mode="date-of-month" selectedDayNumbers={selected} onDayNumbersChange={setSelected} width={284} />
        <p style={{
        fontFamily: 'var(--ds-font-family-base)',
        fontSize: 12,
        color: '#616E88',
...
No month/year header or navigation. Toggle individual day numbers.`,..._.parameters?.docs?.description}}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  name: 'All Variants',
  render: () => {
